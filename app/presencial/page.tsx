...
const Ciclos: Virtuales[] = [
{
    ...
    fechaInicio:'Miercoles 14 de Marzo',
    fechaInscripcion: 'Inscripcion Continua',
    ubicacion:'Salon Anitguo Iglesia La Macarena',
    informacionNecesaria: 'Nos reuniremos en la persona, comunicarse para mas informacion'
},
{
  iframeSrc:'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7846423.651546418!2d-68.84784508736185!3d-16.20698811952281!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x915edf8977bba295%3A0x1c9ec2bb0115edbf!2sBolivia!5e0!3m2!1sen!2sbo!4v1709311608171!5m2!1sen!2sbo',
  fechaInicio:'Lunes 26 de Febrero ',
  fechaInscripcion: 'Inscripcion Continua',
  ubicacion:'Salon Parroquial Espiritu Santo',
  informacionNecesaria: 'Nos reuniremos en la persona, comunicarse para mas informacion'
},
  ...
  return (
    <div className='flex flex-col w-full min-h-screen p-4 gap-10 relative'>
        <header className='flex flex-col w-full items-center justify-center'>
            <h1 className='text-5xl font-semibold text-black '>Fechas de Inicio de Ciclos Presenciales 2024</h1>
        </header>
